## [#](5-浏览器模块.html#_1-跨标签页通讯) 1 跨标签页通讯
...
![](https://www.123fe.net/fe-api/uploads/2022/08/aeec07248588bf72.png)
...
![](https://www.123fe.net/fe-api/gitee/2020/09/96.png)
...
### [#](5-浏览器模块.html#_8-3-css-加载会造成阻塞吗) 8.3 css 加载会造成阻塞吗 ？
