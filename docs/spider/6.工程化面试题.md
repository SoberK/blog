## [#](9-前端工程模块.html#_1-webpack的基本配置) 1 webpack的基本配置
...
![](https://www.123fe.net/fe-api/uploads/2023/02/a9f33d5b7fb0dfad.png)
...
### [#](9-前端工程模块.html#_1-3-模块包装) 1.3 模块包装
...
### [#](9-前端工程模块.html#_1-5-webpack的打包原理详细) 1.5 webpack的打包原理详细
...
### [#](9-前端工程模块.html#优化webpack打包速度) 优化webpack打包速度
...
![](https://www.123fe.net/fe-api/uploads/2023/02/e784fca92b368db7.png)

## [#](9-前端工程模块.html#_21-tree-shaking原理是什么) 21 Tree Shaking原理是什么

### [#](9-前端工程模块.html#对tree-shaking的了解) 对tree-shaking的了解
...
## [#](9-前端工程模块.html#_22-vite了解吗) 22 Vite了解吗
...
![](https://www.123fe.net/fe-api/images/20210315165345.png)

### [#](9-前端工程模块.html#vite-为什么启动非常快) Vite 为什么启动非常快
...
## [#](9-前端工程模块.html#_23-面试真题) 23 面试真题

### [#](9-前端工程模块.html#前端为何打包和构建) 前端为何打包和构建
...
### [#](9-前端工程模块.html#module-chunk-bundle区别) module chunk bundle区别

  * `moudle`各个源码文件，`webpack`中一切皆模块
  * `chunk` 多模块合并成的，如`entry`中定义的、`import()`动态导入的、`splitChunks`拆分的
  * `bundle` 最终输出的文件

### [#](9-前端工程模块.html#loader和plugin区别) loader和plugin区别

  * **loader模块转化** `scss`=>`css`
  * **plugin插件** ，扩展功能，如`html-webpack-plugin`、`clean-webpack-plugin`

### [#](9-前端工程模块.html#babel和webpack的区别) babel和webpack的区别

  * `babel` `JS`新语法编译工具，不关系模块化
  * `webpack` 模块化打包工具，是多个`loader`、`plugin`的集合`

### [#](9-前端工程模块.html#babel-polyfill和babel-runtime的区别) babel-polyfill和babel-
runtime的区别
...
### [#](9-前端工程模块.html#webpack如何实现懒加载) webpack如何实现懒加载

  * `import()`语法
  * 结合`vue`、`react`异步组件
  * 结合`vue-router`、`react-router`异步加载路由

### [#](9-前端工程模块.html#为何proxy不能被polyfill) 为何proxy不能被polyfill

  * 如`Class`可以用`funcition`模拟
  * 如`Promise`可以用`callback`模拟
  * 但`Proxy`的功能用`Object.defineProperty`无法模拟

### [#](9-前端工程模块.html#webpack优化) webpack优化

#### [#](9-前端工程模块.html#优化构建速度) 优化构建速度
