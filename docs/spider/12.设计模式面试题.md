...
### [#](15-设计模式.html#_2-1-单例模式的实现思路) 2.1 单例模式的实现思路
...
### [#](15-设计模式.html#_8-4-实现一个event-bus-event-emitter) 8.4 实现一个Event Bus /
Event Emitter
...
### [#](15-设计模式.html#_8-5-观察者模式与发布-订阅模式的区别是什么) 8.5 观察者模式与发布-订阅模式的区别是什么？
...
![](https://www.123fe.net/fe-api/images/20210327211020.png)

**观察者模式**

![](https://www.123fe.net/fe-api/images/20210327211122.png)
...
## [#](15-设计模式.html#_9-行为型-迭代器模式) 9 行为型-迭代器模式

> 迭代器模式提供一种方法顺序访问一个聚合对象中的各个元素，而又不暴露该对象的内部表示。 ——《设计模式：可复用面向对象软件的基础》

迭代器模式是设计模式中少有的**目的性极强的模式** 。所谓“目的性极强”就是说它不操心别的，它就解决这一个问题——遍历。

### [#](15-设计模式.html#_9-1-公元前-的迭代器模式) 9.1 “公元前”的迭代器模式
...
![](https://www.123fe.net/fe-api/images/20210327212411.png)
...
![](https://www.123fe.net/fe-api/images/20210327212836.png)

>
> 可以看出，`jQuery`的迭代器为我们统一了不同类型集合的遍历方式，使我们在访问集合内每一个成员时不用去关心集合本身的内部结构以及集合与集合间的差异，这就是迭代器存在的价值~

### [#](15-设计模式.html#_9-2-es6对迭代器的实现) 9.2 ES6对迭代器的实现
...
![](https://www.123fe.net/fe-api/images/20210327213037.png)
...
### [#](15-设计模式.html#_9-3-实现一个迭代器生成函数) 9.3 实现一个迭代器生成函数
...
![](https://www.123fe.net/fe-api/images/20210327213223.png)
...
![](https://www.123fe.net/fe-api/images/20210327213700.png)
...
## [#](15-设计模式.html#_10-中介者模式) 10 中介者模式
