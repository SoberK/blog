...
![](https://www.123fe.net/fe-api/gitee/2020/07/61.png)
...
### [#](7-Vue.html#vue生命周期钩子是如何实现的) Vue生命周期钩子是如何实现的
...
## [#](7-Vue.html#_16-vue-diff算法相关问题) 16 Vue diff算法相关问题

### [#](7-Vue.html#vue为什么需要虚拟dom-优缺点有哪些) Vue为什么需要虚拟DOM？优缺点有哪些
...
![](https://www.123fe.net/fe-api/uploads/2022/08/8154cc1efc0aea96.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/8599e34fabc9a45f.gif)
...
### [#](7-Vue.html#vue中diff算法原理) Vue中diff算法原理
...
![](https://www.123fe.net/fe-api/uploads/2022/08/15b3a98fc9f361d8.png)
...
**回答范例**
  ...
  1. `Vue`中的`diff`算法称为`patching`算法，它由`Snabbdo`m修改而来，虚拟`DOM`要想转化为真实`DOM`就需要通过`patch`方法转换
  ...
  3. `vue`中`diff`执行的时刻是组件内响应式数据变更触发实例执行其更新函数时，更新函数会再次执行`render`函数获得最新的虚拟`DOM`，然后执行`patc`h函数，并传入新旧两次虚拟DOM，通过比对两者找到变化的地方，最后将其转化为对应的`DOM`操作
...
### [#](7-Vue.html#vue的diff算法详细分析) Vue的diff算法详细分析
...
### [#](7-Vue.html#vue2和vue3和react三者的diff算法有什么区别)
...
![](https://www.123fe.net/fe-api/uploads/2023/01/4c213c57e4a91c38.png)

**React diff仅右移动**

![](https://www.123fe.net/fe-api/uploads/2023/01/8c436b7f707c2e0d.png)
...
![](https://www.123fe.net/fe-api/uploads/2023/01/b200d667af842b4d.png)
...
### [#](7-Vue.html#既然vue通过数据劫持可以精准探测数据变化-为什么还需要虚拟dom进行diff检测差异)
...
### [#](7-Vue.html#请说明vue中key的作用和原理-谈谈你对它的理解) 请说明Vue中key的作用和原理，谈谈你对它的理解

![](https://www.123fe.net/fe-api/gitee/2020/07/67.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/8c7511b8697e15ea.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/9902d8c15277fb57.png)

### [#](7-Vue.html#异步组件是什么-使用场景有哪些) 异步组件是什么？使用场景有哪些？
...
### [#](7-Vue.html#为什么要使用异步组件) 为什么要使用异步组件
...
### [#](7-Vue.html#vue组件之间通信方式有哪些) Vue组件之间通信方式有哪些
...
![](https://www.123fe.net/fe-api/uploads/2022/08/e6c7ede9c5ab6d49.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/b96d3c0fcf648316.png)
...
### [#](7-Vue.html#组件中写name属性的好处) 组件中写name属性的好处
...
### [#](7-Vue.html#vue-extend-作用和原理) Vue.extend 作用和原理
...
### [#](7-Vue.html#vue中如何扩展一个组件) Vue中如何扩展一个组件
...
### [#](7-Vue.html#子组件可以直接改变父组件的数据么-说明原因) 子组件可以直接改变父组件的数据么，说明原因
...
### [#](7-Vue.html#什么是递归组件-举个例子说明下) 什么是递归组件？举个例子说明下？
...
### [#](7-Vue.html#vue中组件和插件有什么区别) Vue中组件和插件有什么区别
...
## [#](7-Vue.html#_18-为什么vue采用异步渲染) 18 为什么Vue采用异步渲染

> Vue 是组件级更新，如果不采用异步更新，那么每次更新数据都会对当前组件进行重新渲染，所以为了性能， Vue
> 会在本轮数据更新后，在异步更新视图。核心思想 `nextTick`

![](https://www.123fe.net/fe-api/uploads/2022/08/0b0716bd40a4ce7c.png)
...
## [#](7-Vue.html#_19-v-if和v-show区别) 19 v-if和v-show区别
...
## [#](7-Vue.html#_20-v-if和v-for哪个优先级更高) 20 v-if和v-for哪个优先级更高
...
## [#](7-Vue.html#_21-vue的事件绑定原理) 21 Vue的事件绑定原理
...
![](https://www.123fe.net/fe-api/uploads/2022/08/e0f6b652df9a5418.png)
...
## [#](7-Vue.html#_22-vue-是如何实现数据双向绑定的) 22 Vue 是如何实现数据双向绑定的

`Vue` 数据双向绑定主要是指：数据变化更新视图，视图变化更新数据，如下图所示：

![](https://www.123fe.net/fe-api/uploads/2022/08/195830df8ba5d910.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/976bacb8910af5bd.png)

**Vue 数据双向绑定原理图**

![](https://www.123fe.net/fe-api/uploads/2022/08/aab95455d08d851d.png)

### [#](7-Vue.html#双向绑定的原理是什么) 双向绑定的原理是什么
...
![](https://www.123fe.net/fe-api/uploads/2022/09/60c6dfd81740142d.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/c3c70111cc822594.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/ee371a7be5114436.png)
...
## [#](7-Vue.html#_23-v-model双向绑定原理) 23 v-model双向绑定原理

### [#](7-Vue.html#v-model实现原理) v-model实现原理
...
### [#](7-Vue.html#vue中修饰符-sync与v-model的区别) Vue中修饰符.sync与v-model的区别
...
![](https://www.123fe.net/fe-api/uploads/2022/08/a50931f6f3c0cf0c.png)
...
## [#](7-Vue.html#_24-什么是作用域插槽) 24 什么是作用域插槽
...
![](https://www.123fe.net/fe-api/uploads/2022/08/e2fdf798ea0f3d40.png)
...
## [#](7-Vue.html#_25-keep-alive原理) 25 keep-alive原理

### [#](7-Vue.html#keep-alive-使用场景和原理) keep-alive 使用场景和原理
...
![](https://www.123fe.net/fe-api/uploads/2022/08/beabc92317439472.png)
...
### [#](7-Vue.html#怎么缓存当前的组件-缓存后怎么更新) 怎么缓存当前的组件？缓存后怎么更新
...
## [#](7-Vue.html#_26-vue路由相关) 26 Vue路由相关

### [#](7-Vue.html#vue-router基本使用) Vue-router基本使用
...
### [#](7-Vue.html#vue-router-动态路由是什么) vue-router 动态路由是什么
...
### [#](7-Vue.html#router-link和router-view是如何起作用的) router-link和router-
view是如何起作用的
...
### [#](7-Vue.html#vue-router-除了-router-link-怎么实现跳转) Vue-router 除了 router-link
怎么实现跳转
...
### [#](7-Vue.html#vue-router-路由模式有几种) Vue-router 路由模式有几种
...
### [#](7-Vue.html#vue路由hash模式和history模式) Vue路由hash模式和history模式
...
### [#](7-Vue.html#了解history有哪些方法吗-说下它们的区别) 了解history有哪些方法吗？说下它们的区别
...
### [#](7-Vue.html#如何监听-pushstate-和-replacestate-的变化呢) 如何监听 pushState 和
replaceState 的变化呢？
...
### [#](7-Vue.html#vue路由的钩子函数) Vue路由的钩子函数
...
### [#](7-Vue.html#route和-router的区别) `$route`和`$router`的区别

  * `$route`是“路由信息对象”，包括`path`，`params`，`hash`，`query`，`fullPath`，`matched`，`name`等路由信息参数。
  * 而`$router`是“路由实例”对象包括了路由的跳转方法，钩子函数等

### [#](7-Vue.html#vue-router-路由钩子函数是什么-执行顺序是什么) vue-router 路由钩子函数是什么 执行顺序是什么
...
### [#](7-Vue.html#vue-router-有哪几种导航守卫) vue-router 有哪几种导航守卫
...
### [#](7-Vue.html#vue-router守卫) vue-router守卫
...
### [#](7-Vue.html#vue-router中如何保护路由) vue-router中如何保护路由
...
### [#](7-Vue.html#怎么实现路由懒加载呢) 怎么实现路由懒加载呢
...
### [#](7-Vue.html#vue要做权限管理该怎么做-控制到按钮级别的权限怎么做) Vue要做权限管理该怎么做？控制到按钮级别的权限怎么做？
...
![](https://www.123fe.net/fe-api/uploads/2022/08/1715e3218aeb3d7c.png)
...
**回答范例**
  ...
  * 按钮权限的控制通常会`实现一个指令`，例如`v-permission`，将按钮要求角色通过值传给v`-permission`指令，在指令的`moutned`钩子中可以判断当前用户角色和按钮是否存在交集，有则保留按钮，无则移除按钮
...
### [#](7-Vue.html#如果让你从零开始写一个vue路由-说说你的思路) 如果让你从零开始写一个vue路由，说说你的思路

**思路分析：**

首先思考`vue`路由要解决的问题：用户点击跳转链接内容切换，页面不刷新。

  * 借助`hash`或者h`istory api`实现`url`跳转页面不刷新
...
## [#](7-Vue.html#_27-vuex相关) 27 Vuex相关

### [#](7-Vue.html#vuex是什么-怎么使用-哪种功能场景使用它) vuex是什么？怎么使用？哪种功能场景使用它？
...
![](https://www.123fe.net/fe-api/gitee/2020/07/62.png)
...
![](https://www.123fe.net/fe-api/gitee/2020/07/63.png)

>
> `modules`：项目特别复杂的时候，可以让每一个模块拥有自己的`state`、`mutation`、`action`、`getters`，使得结构非常清晰，方便管理

![](https://www.123fe.net/fe-api/gitee/2020/07/64.png)
...
### [#](7-Vue.html#vuex中actions和mutations有什么区别) Vuex中actions和mutations有什么区别
...
### [#](7-Vue.html#怎么监听vuex数据的变化) 怎么监听vuex数据的变化
...
### [#](7-Vue.html#vuex-页面刷新数据丢失怎么解决) Vuex 页面刷新数据丢失怎么解决
...
### [#](7-Vue.html#vuex-为什么要分模块并且加命名空间) Vuex 为什么要分模块并且加命名空间

  * **模块** : 由于使用单一状态树，应用的所有状态会集中到一个比较大的对象。当应用变得非常复杂时，`store` 对象就有可能变得相当臃肿。为了解决以上问题，`Vuex` 允许我们将 `store` 分割成模块（`module`）。每个模块拥有自己的 `state`、`mutation`、`action`、`getter`、甚至是嵌套子模块
  * **命名空间** ：默认情况下，模块内部的 `action`、`mutation` 和 `getter` 是注册在全局命名空间的——这样使得多个模块能够对同一 `mutation` 或 `action` 作出响应。如果希望你的模块具有更高的封装度和复用性，你可以通过添加 `namespaced: true` 的方式使其成为带命名空间的模块。当模块被注册后，它的所有 `getter`、`action` 及 `mutation` 都会自动根据模块注册的路径调整命名

### [#](7-Vue.html#你有使用过vuex的module吗) 你有使用过vuex的module吗？
...
### [#](7-Vue.html#你觉得vuex有什么缺点) 你觉得vuex有什么缺点
...
### [#](7-Vue.html#用过pinia吗-有什么优点) 用过pinia吗？有什么优点？
...
## [#](7-Vue.html#_28-对vue-ssr的理解) 28 对Vue SSR的理解
...
## [#](7-Vue.html#_29-vue-修饰符有哪些) 29 Vue 修饰符有哪些

### [#](7-Vue.html#vue中修饰符分为以下五种) vue中修饰符分为以下五种
...
## [#](7-Vue.html#_30-说说-vue-内置指令) 30 说说 vue 内置指令

![](https://www.123fe.net/fe-api/uploads/2022/08/0e8989f9c8100b9a.png)

## [#](7-Vue.html#_31-怎样理解-vue-的单向数据流) 31 怎样理解 Vue 的单向数据流
...
## [#](7-Vue.html#_32-写过自定义指令吗-原理是什么) 32 写过自定义指令吗？原理是什么
...
### [#](7-Vue.html#vue3-2-自定义全局指令、局部指令) vue3.2 自定义全局指令、局部指令
...
## [#](7-Vue.html#_33-vue3相关) 33 Vue3相关

### [#](7-Vue.html#vue3-对-vue2-有什么优势) Vue3 对 Vue2 有什么优势
...
### [#](7-Vue.html#vue3-和-vue2-的生命周期有什么区别) Vue3 和 Vue2 的生命周期有什么区别
...
### [#](7-Vue.html#vue3如何实现响应式) Vue3如何实现响应式
...
### [#](7-Vue.html#如何理解composition-api和options-api) 如何理解Composition
API和Options API
...
### [#](7-Vue.html#composition-api-如何实现逻辑复用) Composition API 如何实现逻辑复用
...
### [#](7-Vue.html#composition-api-和-react-hooks-的对比) Composition API 和 React
Hooks 的对比
...
### [#](7-Vue.html#vue3的设计目标是什么-做了哪些优化) Vue3的设计目标是什么？做了哪些优化
...
![](https://www.123fe.net/fe-api/uploads/2022/09/f223c5d4157351f4.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/c17ce45b7fdc302a.png)
...
### [#](7-Vue.html#vue3有了解过吗-能说说跟vue2的区别吗) Vue3有了解过吗？能说说跟vue2的区别吗？

**1\. 哪些变化**

![](https://www.123fe.net/fe-api/uploads/2022/09/049a80c13ad8fba9.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/5e2b7ed267793461.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/012cda86feaa9b93.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/dbd78b33807a1196.png)

**更好的Typescript支持**

`VUE3`是基于`typescipt`编写的，可以享受到自动的类型定义提示

![](https://www.123fe.net/fe-api/uploads/2022/09/440059fdfdb0fb0a.png)

**1.4 编译器重写**

![](https://www.123fe.net/fe-api/uploads/2022/09/2ec6c2e81e6d9996.png)

**1.5 更接近原生**

可以自定义渲染 API

![](https://www.123fe.net/fe-api/uploads/2022/09/88eb4d1859e9a619.png)

**1.6 更易使用**

响应式 `Api` 暴露出来

![](https://www.123fe.net/fe-api/uploads/2022/09/5448e66d67acb711.png)

轻松识别组件重新渲染原因

![](https://www.123fe.net/fe-api/uploads/2022/09/55ba7c3f18ce4330.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/b079618d8640aed7.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/f595ce429612b282.png)

关于`compositon api`的使用，这里以下图展开

![](https://www.123fe.net/fe-api/uploads/2022/09/a92a5ac0c6ec602a.png)
...
### [#](7-Vue.html#vue3速度快的原因) Vue3速度快的原因
...
![](https://www.123fe.net/fe-api/uploads/2023/02/36af2f141c7659aa.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/d299e4ac4d29052a.png)

**Vue3.0的diff算法**

`vue3.0`的`diff`算法有个叫静态标记（`PatchFlag`）的小玩意，啥是静态标记呢？简单点说，就是如果你的内容会变，我会给你一个`flag`，下次数据更新的时候我直接来对比你，我就不对比那些没有标记的了

![](https://www.123fe.net/fe-api/uploads/2022/08/216dc586400c35fb.png)
...
### [#](7-Vue.html#composition-api-与-options-api-有什么不同) Composition API 与
Options API 有什么不同
...
![](https://www.123fe.net/fe-api/uploads/2022/08/42c5530ad23d0361.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/87829ae3ab62f60f.gif)
![](https://www.123fe.net/fe-api/uploads/2022/08/b103d51e49714aa9.gif)

**体验**

`Composition API`能更好的组织代码，下面用`composition api`可以提取为`useCount()`，用于组合、复用

![](https://www.123fe.net/fe-api/uploads/2022/08/1687b11c5dfe0743.png)
...
### [#](7-Vue.html#toref和torefs如何使用和最佳方式) toRef和toRefs如何使用和最佳方式
...
![](https://www.123fe.net/fe-api/uploads/2023/02/99525a723bd206bd.png)
...
### [#](7-Vue.html#深入理解为什么需要ref、toref、torefs) 深入理解为什么需要ref、toRef、toRefs
...
### [#](7-Vue.html#ref和reactive异同) ref和reactive异同
...
### [#](7-Vue.html#vue3升级了哪些重要功能) vue3升级了哪些重要功能
...
### [#](7-Vue.html#vue3-2-setup-语法糖汇总) Vue3.2 setup 语法糖汇总
...
### [#](7-Vue.html#v-model参数的用法) v-model参数的用法
...
### [#](7-Vue.html#watch和watcheffect的区别) watch和watchEffect的区别
...
### [#](7-Vue.html#setup中如何获取组件实例) setup中如何获取组件实例
...
### [#](7-Vue.html#vite-为什么启动非常快) Vite 为什么启动非常快
...
### [#](7-Vue.html#说说vue-3-0中tree-shaking特性-举例说明一下) 说说Vue 3.0中Tree
shaking特性？举例说明一下？
...
![](https://www.123fe.net/fe-api/uploads/2022/09/3886fc8c2dbc3985.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/6045e7bd46dc48f3.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/30de7985e2521249.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/0bf1724126701e32.png)
...
## [#](7-Vue.html#_34-vue中v-html会导致哪些问题) 34 Vue中v-html会导致哪些问题
...
## [#](7-Vue.html#_35-说下-attrs和-listeners的使用场景) 35 说下$attrs和$listeners的使用场景
...
## [#](7-Vue.html#_36-在vue中使用插件的步骤) 36 在Vue中使用插件的步骤

  * 采用`ES6`的`import ... from ...`语法或`CommonJS`的`require()`方法引入插件
  * 使用全局方法`Vue.use( plugin )`使用插件,可以传入一个选项对象`Vue.use(MyPlugin, { someOption: true })`

## [#](7-Vue.html#_37-vue-cli-工程技术集合介绍) 37 vue-cli 工程技术集合介绍

### [#](7-Vue.html#构建的-vue-cli-工程都到了哪些技术-它们的作用分别是什么) 构建的 vue-cli
工程都到了哪些技术，它们的作用分别是什么
...
### [#](7-Vue.html#vue-cli-工程常用的-npm-命令有哪些) vue-cli 工程常用的 npm 命令有哪些
...
### [#](7-Vue.html#请说出vue-cli项目中src目录每个文件夹和文件的用法) 请说出vue
...
## [#](7-Vue.html#_38-delete和vue-delete删除数组的区别) 38 delete和Vue.delete删除数组的区别？
...
## [#](7-Vue.html#_39-v-on可以监听多个方法吗) 39 v-on可以监听多个方法吗？
...
## [#](7-Vue.html#_40-v-once的使用场景有哪些) 40 v-once的使用场景有哪些
...
## [#](7-Vue.html#_43-class-与-style-如何动态绑定) 43 Class 与 Style 如何动态绑定
...
## [#](7-Vue.html#_44-vue为什么没有类似于react中shouldcomponentupdate的生命周期) 44
...
## [#](7-Vue.html#_45-spa、ssr的区别是什么) 45 SPA、SSR的区别是什么
...
![](https://www.123fe.net/fe-api/uploads/2022/08/a3c8cf7c4b9b8825.png)

SPA

![](https://www.123fe.net/fe-api/uploads/2022/08/46149f14f3674b16.png)

**部署上的区别**

![](https://www.123fe.net/fe-api/uploads/2022/08/e302c2f6998f2c7e.png)

## [#](7-Vue.html#_46-vue-loader是什么-它有什么作用) 46 vue-loader是什么？它有什么作用？
...
## [#](7-Vue.html#_47-说说你对slot的理解-slot使用场景有哪些) 47 说说你对slot的理解？slot使用场景有哪些

### [#](7-Vue.html#slot是什么) slot是什么
...
## [#](7-Vue.html#_48-vue-observable你有了解过吗-说说看) 48 Vue.observable你有了解过吗？说说看

### [#](7-Vue.html#observable-是什么) Observable 是什么
...
## [#](7-Vue.html#_49-vue中的过滤器了解吗-过滤器的应用场景有哪些) 49 Vue中的过滤器了解吗？过滤器的应用场景有哪些？
...
## [#](7-Vue.html#_50-vue项目中有封装过axios吗-主要是封装哪方面的) 50
Vue项目中有封装过axios吗？主要是封装哪方面的？

### [#](7-Vue.html#axios是什么) axios是什么
...
## [#](7-Vue.html#_51-说下你的vue项目的目录结构-如果是大型项目你该怎么划分结构和划分组件呢) 51
说下你的vue项目的目录结构，如果是大型项目你该怎么划分结构和划分组件呢

### [#](7-Vue.html#为什么要划分) 为什么要划分
...
## [#](7-Vue.html#_52-从0到1自己构架一个vue项目-说说有哪些步骤、哪些重要插件、目录结构你会怎么组织) 52
...
## [#](7-Vue.html#_53-vue要做权限管理该怎么做-如果控制到按钮级别的权限怎么做) 53
...
## [#](7-Vue.html#_54-vue项目中你是如何解决跨域的呢) 54 Vue项目中你是如何解决跨域的呢

### [#](7-Vue.html#跨域是什么) 跨域是什么
...
!![](https://www.123fe.net/fe-api/uploads/2022/09/ef93fd7632d18368.png)
...
## [#](7-Vue.html#_55-vue项目本地开发完成后部署到服务器后报404是什么原因呢) 55
Vue项目本地开发完成后部署到服务器后报404是什么原因呢

### [#](7-Vue.html#如何部署) 如何部署
...
## [#](7-Vue.html#_56-实际工作中-你总结的vue最佳实践有哪些) 56 实际工作中，你总结的vue最佳实践有哪些
...
## [#](7-Vue.html#_57-vue-中使用了哪些设计模式) 57 vue 中使用了哪些设计模式
...
## [#](7-Vue.html#_58-如果让你从零开始写一个vuex-说说你的思路) 58 如果让你从零开始写一个vuex，说说你的思路
...
## [#](7-Vue.html#_59-使用vue渲染大量数据时应该怎么优化-说下你的思路) 59 使用vue渲染大量数据时应该怎么优化？说下你的思路！
...
## [#](7-Vue.html#_60-动态给vue的data添加一个新的属性时会发生什么-怎样解决) 60
...
### [#](7-Vue.html#object-assign) Object.assign()
...
### [#](7-Vue.html#forceupdate) $forceUpdate
...
## [#](7-Vue.html#_61-你是怎么处理vue项目中的错误的) 61 你是怎么处理vue项目中的错误的？
...
## [#](7-Vue.html#_62-spa首屏加载速度慢的怎么解决) 62 SPA首屏加载速度慢的怎么解决

### [#](7-Vue.html#什么是首屏加载) 什么是首屏加载
...
![](https://www.123fe.net/fe-api/uploads/2022/09/83f77ec966a30dd5.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/6140579886e4eada.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/09/ac5076060ba416f5.png)

大家可以根据自己项目的情况选择各种方式进行首屏渲染的优化

## [#](7-Vue.html#_63-vue中常见性能优化) 63 Vue中常见性能优化
...
## [#](7-Vue.html#_64-vue项目性能优化-详细) 64 Vue项目性能优化-详细
...
### [#](7-Vue.html#webpack-层面的优化) Webpack 层面的优化
...
![](https://www.123fe.net/fe-api/uploads/2022/08/7b07d8079454b3db.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/ff03763e07c21600.png)

### [#](7-Vue.html#基础的-web-技术优化) 基础的 Web 技术优化
...
![](https://www.123fe.net/fe-api/uploads/2022/08/5147e6ec0da2e575.png)
...
![](https://www.123fe.net/fe-api/uploads/2022/08/e7a4e7fe64ff0a41.png)

## [#](7-Vue.html#_65-vue与angular以及react的区别) 65 Vue与Angular以及React的区别？

### [#](7-Vue.html#vue与angularjs的区别) Vue与AngularJS的区别
...
### [#](7-Vue.html#vue与react的区别) Vue与React的区别
...
## [#](7-Vue.html#_66-vue2高级用法) 66 Vue2高级用法

### [#](7-Vue.html#自定义组件model) 自定义组件model
...
### [#](7-Vue.html#vue3自定义组件model) vue3自定义组件model
...
### [#](7-Vue.html#vue2-slot) vue2 slot
...
## [#](7-Vue.html#_67-vue面试考察的高频原理) 67 Vue面试考察的高频原理

### [#](7-Vue.html#响应式原理) 响应式原理
...
### [#](7-Vue.html#vdom和diff算法) vdom和diff算法
...
**1\. vdom**
  ...
  * **用JS模拟DOM结构**  
![](https://www.123fe.net/fe-api/uploads/2023/02/34c8532904ffd12f.png)
...
![](https://www.123fe.net/fe-api/uploads/2023/02/9e81506ea3345aea.png)
![](https://www.123fe.net/fe-api/uploads/2023/02/f304938694b28862.png)

**diff过程细节**

  * 新旧节点都有`children`，执行`updateChildren` `diff`对比 ![](https://www.123fe.net/fe-api/uploads/2023/02/2a4ac0a956e99b22.png)
    * 开始和开始对比--头头
    * 结束和结束对比--尾尾
    * 开始和结束对比--头尾
    * 结束和开始对比--尾头
...
![](https://www.123fe.net/fe-api/uploads/2023/02/6f9943fe553bfa0a.png)
...
![](https://www.123fe.net/fe-api/uploads/2023/02/84a8702352c0d1a7.png)
...
### [#](7-Vue.html#组件渲染更新过程-重点掌握) 组件渲染更新过程（重点掌握）
...
**组件渲染更新过程**
  ...
  * **3\. 完成流程图** ![](https://www.123fe.net/fe-api/uploads/2023/02/94729fa5b9fcb082.png)
...
![](https://www.123fe.net/fe-api/uploads/2023/02/6c8606aaa99af5cb.png)
...
## [#](7-Vue.html#_68-vue面试考点答题分析) 68 Vue面试考点答题分析

### [#](7-Vue.html#请说一下响应式数据的理解) 请说一下响应式数据的理解
...
### [#](7-Vue.html#vue如何检测数组变化) Vue如何检测数组变化
...
### [#](7-Vue.html#vue中模板编译原理) Vue中模板编译原理
...
### [#](7-Vue.html#生命周期钩子是如何实现的) 生命周期钩子是如何实现的
...
### [#](7-Vue.html#vue-mixin的使用场景和原理) Vue.mixin的使用场景和原理
...
### [#](7-Vue.html#nexttick在哪里使用-原理是) nextTick在哪里使用?原理是
...
### [#](7-Vue.html#vue为什么需要虚拟dom) Vue为什么需要虚拟DOM
...
### [#](7-Vue.html#vue中的diff原理) Vue中的diff原理
...
### [#](7-Vue.html#vue中computed和watch的区别) Vue中computed和watch的区别
...
### [#](7-Vue.html#vue-set方法是如何实现的) Vue.set方法是如何实现的
...
### [#](7-Vue.html#vue-use是干什么的-原理是什么) Vue.use是干什么的?原理是什么
...
### [#](7-Vue.html#vue-router有几种钩子函数-具体是什么及执行流程是怎样的) vue-
router有几种钩子函数?具体是什么及执行流程是怎样的
